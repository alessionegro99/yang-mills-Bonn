...
typedef struct GParam {
  ...
  char d_Wloop_file[STD_STRING_LENGTH];
  char d_sWloop_file[STD_STRING_LENGTH];
...
void print_parameters_reconfinement(GParam const * const param, time_t time_start, time_t time_end, double acc, char const *program_name);
