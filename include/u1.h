...
// A-=(r*B)
inline void minus_equal_times_real_U1(U1 *restrict A,
                                      U1 const *const restrict B, double r) {
#ifdef DEBUG
  if (A == B) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
            __LINE__);
...
// A=b*B+c*C
inline void lin_comb_U1(U1 *restrict A, double b, U1 const *const restrict B,
...
// A=b*B^{dag}+c*C
inline void lin_comb_dag1_U1(U1 *restrict A, double b,
                             U1 const *const restrict B, double c,
...
// A=b*B+c*C^{dag}
inline void lin_comb_dag2_U1(U1 *restrict A, double b,
                             U1 const *const restrict B, double c,
                             U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
...
// A=b*B^{dag}+c*C^{dag}
inline void lin_comb_dag12_U1(U1 *restrict A, double b,
                              U1 const *const restrict B, double c,
                              U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
...
// A=B*C
inline void times_U1(U1 *restrict A, U1 const *const restrict B,
                     U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
...
inline void diag_matrix_times_U1(U1 *restrict A, double const lambda[1],
...
inline void diag_matrix_times_dag_U1(U1 *restrict A, double const lambda[1],
                                     U1 const *const restrict B) {
#ifdef DEBUG
  if (A == B) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
...
// A=B^{dag}*C
inline void times_dag1_U1(U1 *restrict A, U1 const *const restrict B,
                          U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
...
// A=B*C^{dag}
inline void times_dag2_U1(U1 *restrict A, U1 const *const restrict B,
                          U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
...
// A=B^{dag}*C^{dag}
inline void times_dag12_U1(U1 *restrict A, U1 const *const restrict B,
                           U1 const *const restrict C) {
#ifdef DEBUG
  if (A == B || A == C || B == C) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
...
inline double norm_U1(U1 const *const restrict A) {
  ...
  return sqrt(creal(A->comp) * creal(A->comp) +
              cimag(A->comp) * cimag(A->comp));
}

// real part of the trace
inline double retr_U1(U1 const *const restrict A) { return creal(A->comp); }

// imaginary part of the trace
inline double imtr_U1(U1 const *const restrict A) { return cimag(A->comp); }
...
inline void TensProd_init_U1(TensProd *restrict TP, U1 const *const restrict A1,
                             U1 const *const restrict A2) {
#ifdef DEBUG
  if (A1 == A2) {
    fprintf(stderr, "The same pointer is used twice in (%s, %d)\n", __FILE__,
            __LINE__);
...
// A-=B
inline void minus_equal_U1Vecs(U1Vecs *restrict A,
                               U1Vecs const *const restrict B) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(A->comp), DOUBLE_ALIGN);
  __assume_aligned(&(B->comp), DOUBLE_ALIGN);
#endif
...
// A+=B
inline void plus_equal_U1Vecs(U1Vecs *restrict A,
                              U1Vecs const *const restrict B) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(A->comp), DOUBLE_ALIGN);
  __assume_aligned(&(B->comp), DOUBLE_ALIGN);
...
inline void times_equal_real_single_U1Vecs(U1Vecs *restrict A, double r,
                                           int j) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(A->comp), DOUBLE_ALIGN);
#endif
...
inline void times_equal_complex_single_U1Vecs(U1Vecs *restrict A,
...
inline double re_scal_prod_U1Vecs(U1Vecs const *const restrict v1,
...
// real part of the scalar product re(v_1^{\dag}v_2)
inline double complex complex_scal_prod_U1Vecs(
    U1Vecs const *const restrict v1, U1Vecs const *const restrict v2) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(v1->comp), DOUBLE_ALIGN);
  __assume_aligned(&(v2->comp), DOUBLE_ALIGN);
#endif
...
// indices
inline double re_scal_prod_single_U1Vecs(U1Vecs const *const restrict v1,
                                         U1Vecs const *const restrict v2, int a,
                                         int b) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(v1->comp), DOUBLE_ALIGN);
  __assume_aligned(&(v2->comp), DOUBLE_ALIGN);
...
inline void rotate_two_components_U1Vecs(U1Vecs *restrict v1,
                                         U1Vecs const *const restrict v2, int i,
                                         int j, double angle) {
#ifdef __INTEL_COMPILER
  __assume_aligned(&(v1->comp), DOUBLE_ALIGN);
  __assume_aligned(&(v2->comp), DOUBLE_ALIGN);
  ...
  for (k = 0; k < NCOLOR; k++) {
    v1->comp[NCOLOR * i + k] = cos(angle) * v2->comp[NCOLOR * i + k] +
                               sin(angle) * v2->comp[NCOLOR * j + k];
    v1->comp[NCOLOR * j + k] = -sin(angle) * v2->comp[NCOLOR * i + k] +
                               cos(angle) * v2->comp[NCOLOR * j + k];
  }
}
...
inline void init_FMatrix_U1Vecs(FMatrix *restrict fmatrix,
                                U1Vecs const *const restrict v1) {
#ifdef __INTEL_COMPILER
