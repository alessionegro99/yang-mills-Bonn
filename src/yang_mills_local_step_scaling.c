#ifndef YM_LOCAL_STEP_SCALING_C
#define YM_LOCAL_STEP_SCALING_C
...
void real_main(char *in_file)
    ...
    int count;
    FILE *datafilep, *datafileW, *datafilesW, *monofilep = NULL;
    time_t time1, time2;
    ...
    for(count=1; count < param.d_sample + 1; count++)
       ...
       if(count % param.d_measevery ==0 && count >= param.d_thermal)
         {
         perform_measures_localobs_step_scaling(&GC, &geo, &param, datafilep,
