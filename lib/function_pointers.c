...
void (*diag_matrix_times)(GAUGE_GROUP * restrict A, double const lambda[NCOLOR], GAUGE_GROUP const * const restrict B) = &diag_matrix_times_U1;
void (*diag_matrix_times_dag)(GAUGE_GROUP * restrict A, double const lambda[NCOLOR], GAUGE_GROUP const * const restrict B) = &diag_matrix_times_dag_U1;
void (*comp_MAG_gauge_transformation) (GAUGE_GROUP X_links[2*STDIM], double const lambda[NCOLOR], double OverRelaxParam, GAUGE_GROUP *G_mag) = &comp_MAG_gauge_transformation_U1;
void (*comp_outdiagnorm_of_X) (GAUGE_GROUP X_links[2*STDIM], double const lambda[NCOLOR], double *non_diag_contr) = &comp_outdiagnorm_of_X_U1;
void (*comp_functional_fmag) (GAUGE_GROUP X_links[2*STDIM], double const lambda[NCOLOR], double *fmag) = &comp_functional_fmag_U1;
